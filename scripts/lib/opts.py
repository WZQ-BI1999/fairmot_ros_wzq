...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='/home/ww/catkin_ws/src/fairmot_ros_wzq/models/fairmot_dla34.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--output-root', type=str, default='/home/ww/catkin_ws/src/fairmot_ros_wzq/results', help='expected output root path')
    ...
    self.parser.add_argument('--Mode', '-m', choices=('ZED', 'SVO'), default='ZED',
                    help='data from ZED/data from SVO_FILE')
    self.parser.add_argument('--SVO_path', help='please input svo files path')
